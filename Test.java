...
public class Test extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        leftPIDController = new SanjuPIDController("forward");
        rightPIDController = new SanjuPIDController("forward");
        ...
        while (opModeIsActive()) {
            ...
            telemetry.update();
            driveStraight(36);
            centerPIDController = new SanjuPIDController("right");
            driveStrafe(36);
            sleep(2000);
            leftPIDController = new SanjuPIDController("backward");
            rightPIDController = new SanjuPIDController("backward");
            driveStraight(-36);
            centerPIDController = new SanjuPIDController("left");
            driveStrafe(-36);
